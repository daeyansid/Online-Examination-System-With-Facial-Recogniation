...
<div class="info">
    ...
    <div class="border">
        <span class="num"><?php echo $row_em; ?></span>
        <span class="img">Total Exams Made</span>
    ...
    <div class="border">
        <span class="num"><?php echo $row_ed; ?></span>
        <span class="img">Total Exams Complete</span>
        <i id = "icon" class="fas fa-money-bill-wave"></i>
    </div>
</div>
