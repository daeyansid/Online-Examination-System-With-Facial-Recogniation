  ...
  <div id="app">
   ...
   echo  "<img id='profileImage' src='$uimg' class='mobile_profile_image' alt='Uploaded Photo'>";
      ...
      <div class="main-content">
        ...
        <h1>Instructions :</h1>
        <ul>
        <li><h6> Dear Students Allow the Camera Acces as shownin Image Below</h6></li>
            <img src="assets/img/allow_cam.png" alt="allow_cam">
        <li><h6> Now A screen Will show see eye to eye in the camera and click the capture button</h6></li>
