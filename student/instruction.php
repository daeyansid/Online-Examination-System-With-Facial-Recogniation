...
<div class="instruction">
        <h1>Instructions :</h1>
        <ul>
        <li><h6> All Students Firstly Go to Profile Section And Fill Thier Profile By 100%.</h6></li>
        <li><h6> Register Your face by going into face registration section in menu</h6></li>
        <li><h6> During The Examination No One Allowed to Look any where except The Computer Screen Only Because It is an <i class="fas fa-robot"></i> Artificial Intelligence Based System Which monitors you</h6></li>
        <li><h6> During The Examination No One Allowed to Use Keys Like : ctrl(control Key) OR alt(alter Key) OR tab Key or on one can paste any thing in it or one one allow To leave Exam, If You did any one of this you will fail and Exam System automatically cancle your exam <i class="far fa-times-circle"></i> And you cannot able to rejoin the Exam again</h6></li>
        <li><h6> If you find any Bug or failure of system, so take a picture and send it to Email:-----</h6></li>
        <li><h6> If you have any query or confusion, so Contact Admin & Computer staff</h6></li>
    </ul>
</div>
        </div>
        </section>
