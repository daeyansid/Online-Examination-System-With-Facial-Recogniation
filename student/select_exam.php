...
if (isset($_POST['open_result'])) {
  $exam_name = $_POST['ex_n'];
  header('location:../student/result.php?ex_n='.$exam_name.'');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
$sql_sub = "SELECT * FROM results WHERE class = '$class' and section = '$sec' and roll_no='$roll_no'";
$result_sub = mysqli_query($conn,$sql_sub);
$row_sub = mysqli_num_rows($result_sub);
$i =1;
while($sub = mysqli_fetch_assoc($result_sub)){
    ...
    if($row_sub == 1){
        echo  "<tbody>".
            ...
            <input type='submit' id='btn-$i' class='btn' value='Open Here' name='open_result'>
            </form>".
            "</td>".
            "</tr>
            </tbody>
