...
if (isset($_POST['open_paper'])) {
    ...
    header('location:../teacher/result.php?e='.$exam_id.'&s='.$Subject.'&sec='.$sec.'&ex_n='.$exam_name.'');
...
<ul class="sidebar-menu">
  ...
  <thead>
    ...
    <th>#</th>
      ...
      <th>Exam Name</th>
      <th>Status</th>
      <th>Open Answers Sheet</th>
    </tr>
   </thead>

    <?php
$sql_sub = "SELECT * FROM exam_data WHERE t_id = '$tid'";
...
while($sub = mysqli_fetch_assoc($result_sub)){
    ...
    $exam_id = $sub['exam_id'];
        ...
        <input type='submit' class='btn' value='Open Here' name='open_paper'>
        </form>".
        "</tr>";
            $i =$i +1;
    }
