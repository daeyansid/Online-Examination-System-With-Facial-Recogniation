...
if(isset($_POST['open_exam'])){
    $exam_name = $_POST['e_n'];
    header('location:../teacher/select_st.php?e_n='.$exam_name.'');
}
?>
<!DOCTYPE html>
<html lang="en">
...
while($exam_created = mysqli_fetch_assoc($result_e)){
    ...
    $time = $exam_created['time'];
            ...
            "<td>"."<form method='post'>
            <input type='hidden' name='e_n' value='"."$exam_name"."'>
            <input type='submit' class='btn' id='btn-$i' value='Open Here' name='open_exam'>
            </form>"."</td>".
            "</tr>";
            $i =$i +1;
    }
