...
// End of profile_img
// ------------------------- //
if (isset($_POST['open_marksheet'])) {
  $roll_no = $_POST['roll'];
  $sec = $_POST['sec'];
  header('location:../teacher/maksheet.php?s='.$roll_no.'&se='.$sec.'&c='.$class.'&e_n='.$url_exam_name.'');
...
while($row = mysqli_fetch_assoc($result_sub)){
        ...
        echo  "<tbody>".
            ...
            <input type='submit' class='btn' value='Open Marksheet' name='open_marksheet'>
            </form>".
            "</tr>";
            $i =$i +1;
    }
